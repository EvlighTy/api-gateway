...
public class ApplicationInterfaceMethodVO {
    ...
    public ApplicationInterfaceMethodVO(Integer id, String systemId, String interfaceId, String methodId, String methodName, String parameterType, String uri, String httpCommandType, Integer auth) {
        this.id = id;
